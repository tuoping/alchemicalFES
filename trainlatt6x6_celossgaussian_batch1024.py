...
os.environ["MODEL_DIR"]=f"logs-gaussian-ising/latt6x6_celoss_b"
...
from lightning_modules.gaussian_module import gaussianModule_celoss
model = gaussianModule_celoss(channels, num_cls=1, hyperparams=hparams)
