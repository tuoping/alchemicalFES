...
os.environ["MODEL_DIR"]=f"logs-dir-ising/latt6x6T{sys.argv[2]}/kernel3x3_timeembed/finetune17/"
os.environ["work_dir"]=os.environ["MODEL_DIR"]

dataset_dir = f"ising-latt6x6-T{sys.argv[2]}/"
...
ckpt = None
import glob
print(os.path.join(os.environ["MODEL_DIR"], f"model-epoch={sys.argv[1]}-train_loss=*"))
